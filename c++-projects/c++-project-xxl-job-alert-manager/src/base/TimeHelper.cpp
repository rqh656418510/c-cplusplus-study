...
int64_t TimeHelper::localToUtcTimestampSec(const std::string& datetime) {
    // 字符串长度必须固定为 19，比如：2025-11-16 17:45:30
    if (datetime.size() != 19) {
        return static_cast<int64_t>(-1);
    }
...
int64_t TimeHelper::localToUtcTimestampMs(const std::string& datetime) {
    // 字符串长度必须固定为 19，比如：2025-11-16 17:45:30
    if (datetime.size() != 19) {
        return static_cast<int64_t>(-1);
    }
...
int64_t TimeHelper::localToUtcTimestampUs(const std::string& datetime) {
    // 字符串长度必须固定为 23，比如：2025-11-16 17:45:30.123
    if (datetime.size() != 23) {
        return static_cast<int64_t>(-1);
    }
