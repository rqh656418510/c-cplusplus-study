...
// 构造函数
ChatClient::ChatClient(muduo::net::EventLoop* loop, const muduo::net::InetAddress& serverAddr,
...
void ChatClient::onMessage(const muduo::net::TcpConnectionPtr& conn, muduo::net::Buffer* buf, muduo::Timestamp time) {
    std::string message = buf->retrieveAllAsString();
    std::cout << "==> client receive message: " << message << ", time: " << time.toFormattedString(false) << std::endl;
}
