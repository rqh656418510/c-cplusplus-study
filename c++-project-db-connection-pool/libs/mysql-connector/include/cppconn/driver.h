...
protected:
  virtual ~Driver() {}
public:
  // Attempts to make a database _connection to the given URL.
...
extern "C"
{
  ...
  /* If dynamic loading is disabled in a _driver then this function works just like get_driver_instance() */
